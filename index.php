<?php
  ...
  $page_title = ' List of users who signed up';
  ...
  $query = "SELECT user_id, first_name, picture, email, phone FROM admin WHERE first_name IS NOT NULL ORDER BY join_date DESC LIMIT 5";
  $data = mysqli_query($dbc, $query);

  // Loop through the array of user data, formatting it as HTML
  echo '<h4>Business Contacts:</h4>';
  echo '<table>';
